...
extract_job = define_asset_job("extract_assets", selection=AssetSelection.groups(EXTRACT))
transform_job = define_asset_job("transform_assets", selection=AssetSelection.groups(TRANSFORM))
