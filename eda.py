...
def agg_downloads(downloads):
    downloads = (
        ...
        .agg(
            ibis._.count().name("downloads").cast("int32"),
        )
...
#
#stars = clean_data(
#    con.read_json("data/raw/github/ibis-project/ibis/2023-07-17/stargazers.*.json")
#)
...
#
#issues = clean_data(
#    con.read_json("data/raw/github/ibis-project/ibis/2023-07-17/issues.*.json")
#)
...
#
#pulls = clean_data(
#    con.read_json("data/raw/github/ibis-project/ibis/2023-07-17/pullRequests.*.json")
#)
...
#
#forks = clean_data(
#    con.read_json("data/raw/github/ibis-project/ibis/2023-07-17/forks.*.json")
#)
...
#
#watchers = clean_data(
#    con.read_json("data/raw/github/ibis-project/ibis/2023-07-17/watchers.*.json")
#)
...
#
#commits = clean_data(
#    con.read_json("data/raw/github/ibis-project/ibis/2023-07-17/commits.*.json")
#)
